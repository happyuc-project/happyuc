...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s happyuc-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  happyuc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded happyuc transaction") + "\n" +
              "  happyuc-tx [options] -create [commands]   " + _("Create hex-encoded happyuc transaction") + "\n" +
              "\n";
